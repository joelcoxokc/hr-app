module.exports = function($, gulp, paths){
  ...
  return {
     ...
     * @name            dev
     * @task            images:dev
     * @description     Create a stream from the ./src/client/ directory for all .images files
     ...
     * @name            stage
     * @task            images:stage
     * @description     Create a stream from the ./src/client/images directory for all .images files
     *                  Compress images with optimization level 3 (for more info checkout https://www.npmjs.com/package/gulp-imagemin)
     *                  Pipe the images files into ./build/images
     * @return {Stream}
     */
