module.exports = function($, gulp, paths){
  ...
  return {
     ...
     *                  Pipe the .jade file through gulp-plumber to keep the command-line from shutting down due to errors
     *                  Compile .jade files into .html files using gulp-jade
     *                  Stop gulp-plumber
     *                  Pipe the .jade files into ./build/jade
     * @return {Stream}
     */
    dev: function(){
     ...
     *                  Pipe the .jade files into ./build/html
     * @return {Stream}
     */
    stage: function(){}
  };
